...
# Replaying a game
Sometimes you need to replay a game. Starting a game a directory called **replays** will be created to host a replay. What is it a **replay** file? It’s the list of actions you performed in your last play. Included environment variable used to define safe combinations.
