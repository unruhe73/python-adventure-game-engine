...
Of course there are **synonymous** and **alias** in the example game (you can change them as you wish or define new *synonymous* and *alias*) to get you more comfortable with an action and to let you use just one charecter to express a long verb, for example **d** stands for **describe** as defined in the example game, of course you can remove it if you prefer type just **describe** to get an item desription, also if I suggest don’t do it becase it’s a very recurring action verb.
